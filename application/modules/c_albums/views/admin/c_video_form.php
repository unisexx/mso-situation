...
<form id="frmMain" action="c_albums/admin/c_videos/save/<?php echo $review->id ?>" method="post" enctype="multipart/form-data" >
...
<table class="form">
	...
	<tr>
		<th></th>
		<td>
			<?php if($review->image != ""):?><?php echo thumb("uploads/c_review/".$review->image,120,false,1);?><?php endif;?>
		</td>
	</tr>
