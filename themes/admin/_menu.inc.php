<ul class="menu">
    ...
    <li <?php echo menu_active('products','products')?>><a href="products/admin/products">ผลิตภัณฑ์</a></li>
    ...
    <li <?php echo menu_active('c_albums','c_albums')?>><a href="c_albums/admin/c_albums">ภาพกิจกรรม & วิดีโอ (จีน)</a></li>
